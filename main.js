...
function my_keydown(e)
{
	...
	function car2_left(){
		if(car2_x>=0){
			car2_x=car2_x - 10;
			console.log("When left arrow is pressed, x = " + car2_y + " | y = " + car2_y);
			uploadBackground();
			uploadcar1();
			uploadcar2();
		}
	...
	function car2_right(){
		if(car2_x<=700){
			car2_x=car2_x + 10;
			console.log("When right arrow is pressed, x = " + car2_y + " | y = " + car2_y);
			uploadBackground();
			uploadcar1();
			uploadcar2();
		}
...
if(car1_x > 700){
	...
	document.getElementById('game_status').innerHTML = "Dragon car WON !!!";
}
if(car2_x > 700){
	console.log("car2 Won");
	document.getElementById('game_status').innerHTML = "Greeen car WON !!!";
}
}
